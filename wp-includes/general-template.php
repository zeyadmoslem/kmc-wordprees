		...
		if ( 'html5' === $format ) {
			$form = '<form role="search" ' . $aria_label . 'method="get" class="search-form" action="' . esc_url( home_url( '/' ) ) . '">
				<label>
					...
					<input type="search" class="search-field" placeholder="' . esc_attr_x( 'suchen &hellip;', 'placeholder' ) . '" value="' . get_search_query() . '" name="s" />
				</label>
			...
			$form = '<form role="search" ' . $aria_label . 'method="get" id="searchform" class="searchform" action="' . esc_url( home_url( '/' ) ) . '">
				<div>
					...
					<input type="submit" id="searchsubmit" value="' . esc_attr_x( 'Suchen', 'submit button' ) . '" />
				</div>
			</form>';
		}
	}
