...
<div id="offcanvas-menu" class="offcanvas-menu-wrap">
	...
	<div class="offcanvas-menu-inner">
		<div class="offcanvas-menu-content">
			...
			<?php if( !get_theme_mod( 'disable_header_button', false ) && !get_theme_mod( 'disable_mobile_header_buttons', false ) && get_theme_mod( 'header_button_text', '' ) && get_theme_mod( 'header_layout', 'header_one' ) != 'header_one' ){
