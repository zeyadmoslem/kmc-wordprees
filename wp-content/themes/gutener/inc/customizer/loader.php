...
add_action( 'customize_register', 'gutener_modify_default_settings' );
...
function gutener_default_styles(){
	...
	$css .= '
		...
		.header-three .site-branding .site-description:after {
			background-color: '. esc_attr( gutener_hex2rgba( $site_tagline_color, 0.4 ) ).';
		}
	';
	...
	if( !get_theme_mod( 'disable_notification_bar', true ) ){
		...
		$notification_bar_height = get_theme_mod( 'notification_bar_height', 40 );
		$css .= '
			@media only screen and (min-width: 992px) {
				.notification-bar {
					height: '. esc_attr( $notification_bar_height ) .'px;
					width: 100%;
					position: relative;
				}
			}
		...
		';
		if( !get_theme_mod( 'disable_notification_bar_button_one', false ) && !empty( get_theme_mod( 'notification_bar_button_text', '' ) ) ){
			$notification_bar_button_text_color 	= get_theme_mod( 'notification_bar_button_text_color', '#ffffff' );
			$notification_bar_button_hover_color 	= get_theme_mod( 'notification_bar_button_hover_color', '' );
			$notification_bar_button_hover_color 	= $notification_bar_button_hover_color ? $notification_bar_button_hover_color : $site_hover_color;
			# Notification Button One Border Radius
			$notification_bar_button_border_radius 	= get_theme_mod( 'notification_bar_button_border_radius', 0 );

			if( get_theme_mod( 'notification_bar_button_type', 'button-primary' ) == 'button-primary' ){
				...
				$css .= '
					...
					.notification-bar .button-primary:active {
						background-color: '. esc_attr( $notification_bar_button_hover_color  ) .';
						border-color: '. esc_attr( $notification_bar_button_hover_color ) .';
						color: #ffffff;
					}
			...
			elseif( get_theme_mod( 'notification_bar_button_type', 'button-primary' ) == 'button-outline' ){
				$notification_bar_button_border_color = get_theme_mod( 'notification_bar_button_border_color', '' );
				$notification_bar_button_border_color 	= $notification_bar_button_border_color ? $notification_bar_button_border_color : $notification_bar_button_text_color;
				$css .= '
					.notification-bar .button-outline {
						color: '. esc_attr( $notification_bar_button_text_color ) .';
						border-color: '. esc_attr( $notification_bar_button_border_color ) .';
					}
			...
			elseif( get_theme_mod( 'notification_bar_button_type', 'button-primary' ) == 'button-text' ){
				$css .= '
					...
					.notification-bar .button-container .button-text:active {
						color: '. esc_attr( $notification_bar_button_hover_color ) .';
					}
				';
			}
		}
	...
	$top_header_text_link_hover_color 	= get_theme_mod( 'top_header_text_link_hover_color', '' );
	$top_header_text_link_hover_color 	= $top_header_text_link_hover_color ? $top_header_text_link_hover_color : $site_hover_color;
	$sub_menu_link_hover_color = get_theme_mod( 'sub_menu_link_hover_color', '' );
	$sub_menu_link_hover_color 	= $sub_menu_link_hover_color ? $sub_menu_link_hover_color : $site_hover_color;
	$css .= '
	...
	$mid_header_text_link_hover_color 	= get_theme_mod( 'mid_header_text_link_hover_color', '' );
	$mid_header_text_link_hover_color 	= $mid_header_text_link_hover_color ? $mid_header_text_link_hover_color : $site_hover_color;
	$css .= '
		.mid-header .overlay {
	...
	$bottom_header_one_background_color 	= get_theme_mod( 'bottom_header_one_background_color', '' );
	...
	$bottom_header_text_link_hover_color 	= get_theme_mod( 'bottom_header_text_link_hover_color', '' );
	$bottom_header_text_link_hover_color 	= $bottom_header_text_link_hover_color ? $bottom_header_text_link_hover_color : $site_hover_color;
	$css .= '
	...
	$transparent_header_top_text_color 			= get_theme_mod( 'transparent_header_top_text_color', '' );
	$top_hover_color_transparent_header 		= get_theme_mod( 'top_hover_color_transparent_header', '' );
	$top_hover_color_transparent_header 		= $top_hover_color_transparent_header ? $top_hover_color_transparent_header : $site_hover_color;
	$site_title_color_transparent_header 		= get_theme_mod( 'site_title_color_transparent_header', '' );
	$site_tagline_color_transparent_header 		= get_theme_mod( 'site_tagline_color_transparent_header', '' );
	$content_color_transparent_header 			= get_theme_mod( 'content_color_transparent_header', '' );
	$content_hover_color_transparent_header 	= get_theme_mod( 'content_hover_color_transparent_header', '' );
	$content_hover_color_transparent_header 	= $content_hover_color_transparent_header ? $content_hover_color_transparent_header : $site_hover_color;

	if( is_front_page() || ( !get_theme_mod( 'disable_transparent_header_post', true ) && is_single() ) || ( !get_theme_mod( 'disable_transparent_header_page', true ) && is_page() ) ){
		if( get_theme_mod( 'site_tagline_color_transparent_header', '' ) ){
			$css .= '
				.transparent-header .site-header.header-three:not(.sticky-header) .site-branding .site-description:before,
				.transparent-header .site-header.header-three:not(.sticky-header) .site-branding .site-description:after {
					background-color: '. esc_attr( gutener_hex2rgba( $site_tagline_color_transparent_header, 0.4 ) ).';
				}
			';
		}
		$css .= '
			...
			.transparent-header .header-three.site-header .header-search-wrap .search-icon {
				color: '. esc_attr( $transparent_header_top_text_color ) .';
			}
			...
			.transparent-header .header-three:not(.sticky-header) .alt-menu-icon .icon-bar:after {
				background-color: '. esc_attr( $transparent_header_top_text_color ) .';
			}
		...
		if ( !get_theme_mod( 'disable_fixed_header', true ) ){
			...
			$text_hover_color_fixed_header 	 = $text_hover_color_fixed_header ? $text_hover_color_fixed_header : $site_hover_color;
			...
			$fixed_header_button_border_color 		 = $fixed_header_button_border_color ? $fixed_header_button_border_color : $fixed_header_button_text_color;
			$fixed_header_button_hover_color 	 	 = get_theme_mod( 'fixed_header_button_hover_color', '' );
			$fixed_header_button_hover_color 		 = $fixed_header_button_hover_color ? $fixed_header_button_hover_color : $site_hover_color;

			if( get_theme_mod( 'site_tagline_color_fixed_header', '' ) ){
				$css .= '
					.transparent-header .site-header.header-three.sticky-header .site-branding .site-description:before,
					.transparent-header .site-header.header-three.sticky-header .site-branding .site-description:after {
						background-color: '. esc_attr( gutener_hex2rgba( $site_tagline_color_fixed_header, 0.4 ) ).';
					}
				';
			}
			$css .= '
				...
				.transparent-header .header-three.site-header.sticky-header .header-btn .button-primary:active {
					background-color: '. esc_attr( $fixed_header_button_hover_color ) .';
					color: #ffffff;
				}
				...
				.transparent-header .header-three.site-header.sticky-header .header-btn .button-outline:active {
					border-color: '. esc_attr( $fixed_header_button_hover_color ) .';
					background-color: '. esc_attr( $fixed_header_button_hover_color ) .';
					color: #ffffff;
				}
				...
				.transparent-header .header-three.site-header.sticky-header .header-btn .button-text:active {
					color: '. esc_attr( $fixed_header_button_hover_color ) .';
				}
			';
		}
	}
	...
	if( is_front_page() || ( !get_theme_mod( 'disable_transparent_header_post', true ) && is_single() ) || ( !get_theme_mod( 'disable_transparent_header_page', true ) && is_page() ) ){
		$transparent_header_button_background_color 	= get_theme_mod( 'transparent_header_button_background_color', '' );
		$transparent_header_button_border_color 		= get_theme_mod( 'transparent_header_button_border_color', '' );
		$transparent_header_button_text_color 			= get_theme_mod( 'transparent_header_button_text_color', '' );
		$transparent_header_button_border_color 		= $transparent_header_button_border_color ? $transparent_header_button_border_color : $transparent_header_button_text_color;
		$transparent_header_button_hover_color 			= get_theme_mod( 'transparent_header_button_hover_color', '' );
		$transparent_header_button_hover_color 			= $transparent_header_button_hover_color ? $transparent_header_button_hover_color : $site_hover_color;

		$css .= '
			.transparent-header .header-three.site-header:not(.sticky-header) .header-btn .button-primary {
				background-color: '. esc_attr( $transparent_header_button_background_color ) .';
				color: '. esc_attr( $transparent_header_button_text_color ) .';
			}
			.transparent-header .header-three.site-header:not(.sticky-header) .header-btn .button-outline {
				color: '. esc_attr( $transparent_header_button_text_color ) .';
				border-color: '. esc_attr( $transparent_header_button_border_color ) .';
			}
			...
			.transparent-header .header-three.site-header:not(.sticky-header) .header-btn .button-primary:active {
				background-color: '. esc_attr( $transparent_header_button_hover_color ) .';
				color: #ffffff;
			}
			...
			.transparent-header .header-three.site-header:not(.sticky-header) .header-btn .button-outline:active {
				border-color: '. esc_attr( $transparent_header_button_hover_color ) .';
				background-color: '. esc_attr( $transparent_header_button_hover_color ) .';
				color: #ffffff;
			}
			...
			.transparent-header .header-three.site-header:not(.sticky-header) .header-btn .button-text:active {
				color: '. esc_attr( $transparent_header_button_hover_color ) .';
			}
		';
	}
	# Header Button
	...
	$header_button_border_color 	= $header_button_border_color ? $header_button_border_color : $header_button_text_color;
	$header_button_hover_color 		= get_theme_mod( 'header_button_hover_color', '' );
	$header_button_hover_color 		= $header_button_hover_color ? $header_button_hover_color : $site_hover_color;
	$css .= '
		...
		.site-header .header-btn .button-primary:active {
			background-color: '. esc_attr( $header_button_hover_color ) .';
			color: #ffffff;
		}
	';
	...
	$css .= '
		...
		.site-header .header-btn .button-outline:active {
			border-color: '. esc_attr( $header_button_hover_color ) .';
			background-color: '. esc_attr( $header_button_hover_color ) .';
			color: #ffffff;
		}
	';
	...
	$css .= '
		...
		.site-header .header-btn .button-text:active {
			color: '. esc_attr( $header_button_hover_color ) .';
		}
	';
	...
	if( $the_custom_logo_url == ''  && ( get_theme_mod( 'header_layout', 'header_one' ) !== 'header_three' || ( !is_front_page() && ( get_theme_mod( 'disable_transparent_header_post', true ) && !is_single() ) && ( get_theme_mod( 'disable_transparent_header_page', true ) && !is_page() ) ) || empty( get_theme_mod( 'header_separate_logo', '' ) ) ) ){
		$css .= '
	...
	/* Fixed Header Site Tagline Border*/
	if( get_theme_mod( 'disable_fixed_header_site_tagline_border', true ) ){
		$css .= '
	...
	if( get_theme_mod( 'disable_mobile_top_header_border', true ) ){
		$css .= '
			@media screen and (max-width: 991px){
				.top-header {
					border-bottom: none;
	...
	if ( get_theme_mod( 'main_slider_controls', 'slider' ) == 'slider' ){
		...
		$slider_button_background_color = get_theme_mod( 'slider_button_background_color', '#f9a032' );
		$slider_button_border_color 	= get_theme_mod( 'slider_button_border_color', '' );
		$slider_button_text_color 		= get_theme_mod( 'slider_button_text_color', '#ffffff' );
		$slider_button_border_color 	= $slider_button_border_color ? $slider_button_border_color : $slider_button_text_color;
		$slider_button_hover_color 		= get_theme_mod( 'slider_button_hover_color', '' );
		$slider_button_hover_color 		= $slider_button_hover_color ? $slider_button_hover_color : $site_hover_color;

		$css .= '
			.section-banner .slide-inner .banner-content .button-container .button-primary {
				background-color: '. esc_attr( $slider_button_background_color ) .';
				color: '. esc_attr( $slider_button_text_color ) .';
			}
			...
			.section-banner .slide-inner .banner-content .button-container .button-primary:active {
				background-color: '. esc_attr( $slider_button_hover_color ) .';
				color: #FFFFFF;
			}
			.section-banner .slide-inner .banner-content .button-container .button-outline {
				border-color: '. esc_attr( $slider_button_border_color ) .';
				color: '. esc_attr( $slider_button_text_color ) .';
			}
			...
			.section-banner .slide-inner .banner-content .button-container .button-outline:active {
				background-color: '. esc_attr( $slider_button_hover_color ) .';
				border-color: '. esc_attr( $slider_button_hover_color ) .';
				color: #FFFFFF;
			}
			...
			.section-banner .slide-inner .banner-content .button-container .button-text:active {
				color: '. esc_attr( $slider_button_hover_color ) .';
			}
		';
	...
	elseif( get_theme_mod( 'main_slider_controls', 'slider' ) == 'banner' ){
		...
		if( !get_theme_mod( 'disable_banner_buttons', false ) ){
			$banner_button_background_color = get_theme_mod( 'banner_button_background_color', '' );
			$banner_button_border_color 	= get_theme_mod( 'banner_button_border_color', '' );
			$banner_button_text_color 		= get_theme_mod( 'banner_button_text_color', '#ffffff' );
			$banner_button_border_color 	= $banner_button_border_color ? $banner_button_border_color : $banner_button_text_color;
			$banner_button_hover_color 		= get_theme_mod( 'banner_button_hover_color', '' );
			$banner_button_hover_color 		= $banner_button_hover_color ? $banner_button_hover_color : $site_hover_color;
			$css .= '
				.section-banner .banner-content .button-container .button-primary {
					background-color: '. esc_attr( $banner_button_background_color ).';
					color: '. esc_attr( $banner_button_text_color ).';
				}
				.section-banner .banner-content .button-container .button-primary:hover,
		    	.section-banner .banner-content .button-container .button-primary:focus,
		    	.section-banner .banner-content .button-container .button-primary:active {
		    		background-color: '. esc_attr( $banner_button_hover_color ) .';
		    		color: #ffffff;
		    	}
				.section-banner .banner-content .button-container .button-outline {
					border-color: '. esc_attr( $banner_button_border_color ) .';
					color: '. esc_attr( $banner_button_text_color ) .';
				}
		    	...
		    	.section-banner .banner-content .button-container .button-outline:active {
		    		background-color: '. esc_attr( $banner_button_hover_color ) .';
		    		border-color: '. esc_attr( $banner_button_hover_color ) .';
		    		color: #ffffff;
		    	}
		    	...
		    	.section-banner .banner-content .button-container .button-text:active {
		    		color: '. esc_attr( $banner_button_hover_color ) .';
		    	}
			';
	...
	$top_footer_widget_link_hover_color = get_theme_mod( 'top_footer_widget_link_hover_color', '' );
	$top_footer_widget_link_hover_color 		= $top_footer_widget_link_hover_color ? $top_footer_widget_link_hover_color : $site_hover_color;
	$css .= '
		.top-footer {
	...
	$css .= '
		...
		.widget ul li,
		.latest-posts-widget .post {
			border-bottom-color: '. esc_attr( gutener_hex2rgba( $top_footer_widget_link_color, 0.2 ) ).';
		}
	...
	$bottom_footer_text_link_hover_color = get_theme_mod( 'bottom_footer_text_link_hover_color', '' );
	$bottom_footer_text_link_hover_color 		= $bottom_footer_text_link_hover_color ? $bottom_footer_text_link_hover_color : $site_hover_color;
	$css .= '
		.bottom-footer {
	...
	#Repeat Size
	elseif( get_theme_mod( 'highlight_posts_image_size', 'cover' ) == 'pattern' ){
		$css .= '
			.highlight-posts-content-wrap .highlight-posts-image {
				background-position: center center;
				background-repeat: repeat;
	...
	#Fit Size
	elseif( get_theme_mod( 'highlight_posts_image_size', 'cover' ) == 'norepeat' ){
		$css .= '
			.highlight-posts-content-wrap .highlight-posts-image {
				background-position: center center;
				background-repeat: no-repeat;
	...
	#Border Radius Highlighted Posts
	...
	if( get_theme_mod( 'highlight_posts_title_alignment', 'align-center' ) == 'align-bottom' ){
		$css .= '
		...
		';
	}elseif( get_theme_mod( 'highlight_posts_title_alignment', 'align-center' ) == 'align-top' ) {
		$css .= '
			.highlight-posts-layout-one .highlight-posts-image {
		...
		';
	}elseif( get_theme_mod( 'highlight_posts_title_alignment', 'align-center' ) == 'align-center' ) {
		$css .= '
			.highlight-posts-layout-one .highlight-posts-image {
    ...
    $blog_post_category_color 	= get_theme_mod( 'blog_post_category_color', '#f9a032' );
	...
	$blog_post_button_background_color 	= get_theme_mod( 'blog_post_button_background_color', '' );
	$blog_post_button_border_color 		= get_theme_mod( 'blog_post_button_border_color', '' );
	$blog_post_button_color 			= get_theme_mod( 'blog_post_button_color', '#333333' );
	$blog_post_button_border_color 		= $blog_post_button_border_color ? $blog_post_button_border_color : $blog_post_button_color;
	$blog_post_button_hover_color 		= get_theme_mod( 'blog_post_button_hover_color', '' );
	$blog_post_button_hover_color 		= $blog_post_button_hover_color ? $blog_post_button_hover_color : $site_hover_color;
	
    $css .= '
    	.post .button-container .button-primary {
    		background-color: '. esc_attr( $blog_post_button_background_color ) .';
    	...
    	.post .button-container .button-primary:active {
    		background-color: '. esc_attr( $blog_post_button_hover_color ) .';
    		color: #ffffff;
    	}
    	.post .button-container .button-outline {
    		border-color: '. esc_attr( $blog_post_button_border_color ) .';
    		color: '. esc_attr( $blog_post_button_color ) .';
    	}
    	...
    	.post .button-container .button-outline:active {
    		background-color: '. esc_attr( $blog_post_button_hover_color ) .';
    		border-color: '. esc_attr( $blog_post_button_hover_color ) .';
    		color: #ffffff;
    	}
    	...
    	.post .button-container .button-text:active {
    		color: '. esc_attr( $blog_post_button_hover_color ) .';
    	}
    ';
	...
	# Blog Homepage
	# Highlighted Posts
	$highlight_post_title_color 	 = get_theme_mod( 'highlight_post_title_color', '#FFFFFF' );
    ...
    $css .= '
    	...
    	.highlight-posts-layout-one .highlight-posts-content .highlight-posts-title a:after {
    		background-color: '. esc_attr( $highlight_post_title_color) .';
    	}
	...
	';
	if(  get_theme_mod( 'disable_highlight_posts_title', false ) || get_theme_mod( 'disable_highlight_title_divider', false ) ){
		$css .= '
			.highlight-posts-layout-one .highlight-posts-content .highlight-posts-title a:after {
    			display: none;
			}
	...
	if( get_theme_mod( 'disable_sticky_mobile_notification_bar', true ) ){
		$css .= '
    ...
    $feature_post_meta_color 		= get_theme_mod( 'feature_post_meta_color', '#7a7a7a' );
    ...
    $css .= '
    	...
    	.feature-post-slider .post .entry-meta a {
    		color: '. esc_attr( $feature_post_meta_color ) .';
    	}
	...
	if( get_theme_mod( 'disable_responsive_instagram_feed', true ) ){
		$css .= '
			@media screen and (max-width: 767px){
	...
	if( get_theme_mod( 'skin_select', 'default' ) == 'dark' ){
		$css .= '
			...
			.site-header .header-image-wrap .overlay {
			...
			.site-header.header-three .top-header,
			.site-header .overlay,
			.header-two .bottom-header .overlay,
			.header-three .bottom-header .overlay {
