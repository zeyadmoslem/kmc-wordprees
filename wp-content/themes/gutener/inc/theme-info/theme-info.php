...
if ( ! class_exists( 'Gutener_Theme_Info' ) ) {
    class Gutener_Theme_Info{
        ...
        public function prepare_class() {
            ...
            $this->menu_title    = $this->theme_name . esc_html__( ' Setup', 'gutener' );
        ...
        public function kt_theme_info_screen() {
            ...
            if (
                ...
                echo '<a href="' . esc_url( 'https://keonthemes.com' ) . '" target="_blank" class="wp-badge epsilon-info-logo"></a>';
                    ...
                    foreach ( $gs_steps as $gs_step ) {
                        ...
                        if( $is_gs ) {
                            if ( is_plugin_active('advanced-import/advanced-import.php') && is_plugin_active('keon-toolset/keon-toolset.php') && is_plugin_active('kirki/kirki.php') && is_plugin_active('gutentor/gutentor.php') && is_plugin_active('breadcrumb-navxt/breadcrumb-navxt.php') ) {
                                echo ('<h3>'.esc_html__('Plugins added successfully. You have completed Step 1.', 'gutener').'</h3>');
                            echo '</div></div>';
                            }else {
                                if ( ! empty( $title ) ) {
                                    echo '<h3>';
                                ...
                                if ( ! empty( $button_label ) ) {
                                    ...
                                    $button_class = '';
                                    if ( $is_button ) {
                                        $button_class = 'button button-primary button-hero gutener-install-plugins';
                                    }
...
$config = array(
    ...
    'info_content' => sprintf( esc_html__( '%s is now installed and ready to use. We hope the following information will help and you enjoy using it!', 'gutener' ), '<b>'.$theme_name_config.'</b>' ),
    ...
    'quick_links' => array(
        ...
        'pro_url'  => array(
            ...
            'url' => 'https://keonthemes.com/downloads/gutener-pro'
        ),
        'rate_url'  => array(
    ...
    'tabs' => array(
        'getting_started'      => esc_html__( 'Getting Started', 'gutener' ),
        'recommended_plugins'  => esc_html__( 'Recommended Plugins', 'gutener' ),
        'support'              => esc_html__( 'Support', 'gutener' ),
        'changelog'            => esc_html__( 'Changelog', 'gutener' ),
        'free_pro'             => esc_html__( 'Free VS Pro', 'gutener' ),
        'demos'                => esc_html__( 'Demos', 'gutener' ),
        'rating'               => esc_html__( 'Rate Theme', 'gutener' )
    ),

    /*Getting started tab*/
    'gs_steps' => array(
        'first' => array(
           'title' => esc_html__( 'Step 1 - To fully take advantage of the best our theme can offer, get started.', 'gutener' ),
            'button_label' => sprintf(esc_html__( 'Get started with %s', 'gutener' ), $theme_name_config ),
            'is_button' => true,
        ...
        'second' => array(
            'title' => esc_html__( 'Step 2 - Checkout starter sites (Demos)', 'gutener' ),
            'desc' => esc_html__( 'All starter demos sites comes attached to Gutener just ready to pick one from. Discover them, be enamoured and finally decide on the one you resonate with. If one doesnt catch your fancy dont be afraid to have a go at building a site with your own design.', 'gutener' ),
            'button_label' => esc_html__( 'View Demo', 'gutener' ),
            'button_link' => esc_url( 'https://demo.keonthemes.com/gutener/' ),
            'is_button' => true,
            'is_new_tab' => true
        ),
        'third' => array (
            'title' => esc_html__( 'Step 3 - Import demo of your choice', 'gutener' ),
            'desc' => esc_html__( 'Once you have a found a site you like, you can move ahead and import it. It is to be noted that some necessary plugins will be installed to function the site as you see in the demo site. A fresh Wordpress site is recommended to mirror the demo site on your setup. Importing the demo on an already running site will create discrepancies with the site shown on the demo.', 'gutener' ),
            'button_label' => esc_html__( 'Import Demo', 'gutener' ),
            'button_link' => esc_url( admin_url( 'themes.php?page=advanced-import' ) ),
            'is_button' => true,
            'is_new_tab' => false
        ),
        'fourth' => array(
            'title' => esc_html__( 'Step 4 - Start editing content and making your site!', 'gutener' ),
            'desc' => esc_html__( 'Once finishing the import you play with the demo to your hearts content.', 'gutener' ),
        ),
        'fifth' => array (
            'title' => esc_html__( "Step 5 - That's it!", 'gutener' ),
            'desc' => esc_html__( 'Go live with the website and enjoy it!', 'gutener' ),
        ),
    ),
    ...
    'support_content' => array(
        'first' => array(
            ...
            'button_link' => esc_url( 'https://keonthemes.com/downloads/gutener-pro' ),
            'is_button' => true,
            'is_new_tab' => true
        ),
        'second' => array (
            'title' => esc_html__( 'Go to Customizer', 'gutener' ),
            'desc' => esc_html__( 'All Settings, Header & Footer Options, Theme Options, Widgets and Menus are available via Customize screen.', 'gutener' ),
        ...
        'third' => array(
            ...
            'button_link' => esc_url( 'http://keonthemes.com/doc/gutener/' ),
            'is_button' => true,
            'is_new_tab' => true
        ),
        'fourth' => array (
            'title' => esc_html__( 'Support Forum', 'gutener' ),
            'desc' => esc_html__( 'Got theme support question or found bug? Simply create a support ticket with your queries and we will get back to you.', 'gutener' ),
            'button_label' => esc_html__( 'Support Forum', 'gutener' ),
            'button_link' => esc_url( 'https://keonthemes.com/forums/forum/gutener-pro' ),
            'is_button' => true,
            'is_new_tab' => true
        ),
        'fifth' => array(
            ...
            'button_link' => esc_url( 'https://keonthemes.com/contact' ),
            'is_button' => true,
            'is_new_tab' => true
        ),
        'sixth' => array(
    ...
    'free_pro' => array (
        'first'=> array(
            'title' => esc_html__( 'Free VS Pro Features', 'gutener' ),
            'desc' => sprintf( esc_html__( '%s is a multipurpose free WordPress theme. However, Gutener Pro comes with more cool and awesome features that give you a flexible and wide range of options to build a full-fledged website.', 'gutener' ), $theme_name_config ),
            'link_title' => esc_html__( 'Check All Features', 'gutener' ),
            'link_url' => esc_url( 'https://keonthemes.com/downloads/gutener-pro' ),
            'is_button' => true,
            'recommended_actions' => false,
            'is_new_tab' => true
        ),
    ...
    'demos' => array (
        'first'=> array(
            ...
            'link_url' => esc_url( 'https://demo.keonthemes.com/gutener' ),
            'is_button' => true,
            'recommended_actions' => false,
            'is_new_tab' => true
        ),
