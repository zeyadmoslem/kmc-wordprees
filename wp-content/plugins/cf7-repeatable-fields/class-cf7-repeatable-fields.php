...
class CF7_Repeatable_Fields {
	...
	public function shortcode_render( $atts, $content ) {
		...
		$add_button = apply_filters(
			...
			"<button type='button' class='wpcf7-field-group-add btn btn-sm btn-success {$add_button_atts['additional_classes']}'>" .
		...
		$remove_button = apply_filters(
			...
			"<button type='button' class='wpcf7-field-group-remove btn btn-sm btn-danger {$remove_button_atts['additional_classes']}'>" .
